...
interface MinecraftTimeContextType {
...
const MinecraftTimeContext = createContext<MinecraftTimeContextType | undefined>(undefined);

interface MinecraftTimeProviderProps {
  children: ReactNode;
}

export function MinecraftTimeProvider({ children }: MinecraftTimeProviderProps) {
  ...
  const value: MinecraftTimeContextType = {
    currentTimeOfDay,
    currentHour,
    currentMinute,
    isManualMode,
  ...
  return (
    <MinecraftTimeContext.Provider value={value}>
      {children}
    </MinecraftTimeContext.Provider>
  );
}

// Custom hook to use the context
export function useMinecraftTime() {
  const context = useContext(MinecraftTimeContext);
  if (context === undefined) {
    throw new Error('useMinecraftTime must be used within a MinecraftTimeProvider');
  }
  return context;
}